...
export const Route = createLazyFileRoute('/_tools/base64-image-preview/')({
...
function RouteComponent() {
  ...
  return (
    <ToolPageLayout title='Base64 Image Preview' icon='bi-eye'>
      <Row xs={1} md={1} lg={2} xl={2} xxl={2}>
        <Col className='mb-3'>
          <Card className='h-100 shadow-sm border-0 rounded-3'>
            <Card.Body>
              <Card.Title className='d-flex align-items-center gap-2 fw-semibold'>
                <i className='bi bi-input-cursor-text text-primary' /> Input Base64
              </Card.Title>
        ...
        <Col className='mb-3'>
          <Card className='h-100 shadow-sm border-0 rounded-3'>
            <Card.Body>
              <Card.Title className='d-flex align-items-center gap-2 fw-semibold'>
                <i className='bi bi-image text-primary' /> Preview
              </Card.Title>
