...
export const Route = createLazyFileRoute('/_tools/mock-data-generator/')({
...
function RouteComponent() {
  ...
  return (
    <ToolPageLayout title='Mock Data Generator' icon='bi-database-fill-gear'>
      <Row xs={1} md={1} lg={2} xl={2} xxl={2}>
        <Col className='mb-3'>
          <Card className='h-100 shadow-sm border-0 rounded-3'>
            <Card.Body>
              <Card.Title className='d-flex align-items-center gap-2 fw-semibold'>
                <i className='bi bi-diagram-3 text-primary' /> Schema Builder
              </Card.Title>
        ...
        <Col className='mb-3'>
          <Card className='h-100 shadow-sm border-0 rounded-3'>
            <Card.Body>
              <Card.Title className='d-flex align-items-center gap-2 fw-semibold'>
                <i className='bi bi-braces text-primary' /> Generated JSON
              </Card.Title>
