...
export const Route = createLazyFileRoute('/image-converter/')({
...
function RouteComponent() {
  ...
  return (
    <Container fluid='xl' className='py-4'>
      ...
      <Row className='mb-4'>
        <Col>
          <h1 className='text-center'>Image Converter</h1>
        </Col>
      </Row>
      <Row xs={1} md={1} lg={2} xl={2} xxl={2}>
        <Col className='mb-3'>
          <Card className='h-100 shadow-sm'>
            <Card.Body>
              <Card.Title>Upload & Options</Card.Title>
              <Form.Control
                type='file'
                accept='image/*'
        ...
        <Col className='mb-3'>
          <Card className='h-100 shadow-sm'>
            <Card.Body>
              <Card.Title>Preview / Download</Card.Title>
              {convertedUrl ? (
                <>
